import { client } from "../sanity"; // This connects to your sanity.js file in the root folder!

export default async function Home() {
  // 1. THE GROQ QUERY: Fetching your actual projects from the Sanity cloud
  // This looks for documents named "project" and grabs their images directly
  ...
  // 2. THE ASYMMETRIC GRID LOGIC
  // This array cycles through different sizes so your Canva, Photoshop, and Figma exports all fit beautifully together.
  const layoutSpans = [
  ...
  return (
    <main className="min-h-screen bg-neutral-950 text-neutral-50 selection:bg-teal-500 selection:text-white font-sans">
      ...
      {/* ASYMMETRIC MASONRY GRID (Now connected to Sanity!) */}
